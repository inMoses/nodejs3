...
const UUID = process.env.UUID || '66fd1229-b893-66c1-84dd-51e7ce206966'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const CFIP = process.env.CFIP || 'usa.visa.com';        // 节点优选域名或优选ip cdns.doon.eu.org  
